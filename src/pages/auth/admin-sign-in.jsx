...
export default function AuthAdminSignIn() {
          ...
          {login && (
            <div className="bg-white w-[97%] md:w-[85%] lg:w-[60%] xl:w-[40%] border shadow-lg rounded-md px-2">
              <div className="border-b border-gray-300 relative py-3">
                ...
                <H6 className="text-center py-3 capitalize ">Admin Login</H6>
              </div>
              <div className="md:w-2/3 px-2 w-full mx-auto text-center pb-14 pt-8">
                ...
                <Button
                  className="w-[100%] capitalize rounded-[35px] py-2 mt-7 px-6 bg-[#FF6F61] text-white text-[22px] font-bold "
                  onClick={save}
                  disabled={loading}
                >
